...
var a = __webpack_require__(87);
var aa = __webpack_require__(88);
var aaa = __webpack_require__(89);
var b = __webpack_require__(90);
var bb = __webpack_require__(91);
var bbb = __webpack_require__(92);
var c = __webpack_require__(93);
var cc = __webpack_require__(94);
var ccc = __webpack_require__(95);
var d = __webpack_require__(96);
var dd = __webpack_require__(97);
var ddd = __webpack_require__(98);
var e = __webpack_require__(99);
var ee = __webpack_require__(100);
var eee = __webpack_require__(101);
var f = __webpack_require__(30);
var ff = __webpack_require__(30);
var fff = __webpack_require__(102);
var g = __webpack_require__(31);
var gg = __webpack_require__(31);
var ggg = __webpack_require__(103);
var h = __webpack_require__(32);
var hh = __webpack_require__(32);
var hhh = __webpack_require__(104);
var i = __webpack_require__(33);
var ii = __webpack_require__(33);
var iii = __webpack_require__(105);
var j = __webpack_require__(34);
var jj = __webpack_require__(34);
var jjj = __webpack_require__(106);
var k = __webpack_require__(35);
var kk = __webpack_require__(35);
var kkk = __webpack_require__(107);
var o = __webpack_require__(36);
var oo = __webpack_require__(36);
var ooo = __webpack_require__(108);
var p = __webpack_require__(37);
var pp = __webpack_require__(37);
var ppp = __webpack_require__(109);
var r = __webpack_require__(38);
var rr = __webpack_require__(38);
var rrr = __webpack_require__(110);
var s = __webpack_require__(39);
var ss = __webpack_require__(39);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    { store: store },
    _react2.default.createElement(_TheGame2.default, null)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(66)(module)))
...
exports.selectedPokemon = selectedPokemon;
...
function selectedPokemon() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _pokemons2.default[0];
    var action = arguments[1];
...
var initialState = {
    playerPokemon: _pokemons2.default[1],
    randomPokemon: _pokemons2.default[0],
...
function battleReducer() {
    ...
    switch (action.type) {
        case "PASS_PLAYER_POKEMON_TO_BATTLE":
            return _extends({}, state, { playerPokemon: action.playerPokemon });
            break;
        ...
        case "PLAYER_POKEMON_ATTACK_SELECTED":
            if (action.attack.type === "modifying_myself") {
                ...
                if (action.attack.target === "atk") {
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { atk: state.playerPokemon.atk + action.attack.power }) });
                }
                if (action.attack.target === "def") {
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { def: state.playerPokemon.def + action.attack.power }) });
                }
                if (action.attack.target === "specAtk") {
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { specAtk: state.playerPokemon.specAtk + action.attack.power }) });
                }
                if (action.attack.target === "specDef") {
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { specDef: state.playerPokemon.specDef + action.attack.power }) });
                }
                if (action.attack.target === "speed") {
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { speed: state.playerPokemon.speed + action.attack.power }) });
                }
                if (action.attack.target === "stamina") {
                    if (state.playerPokemon.stamina + action.attack.power > action.stamina) {
                        return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { stamina: action.stamina }) });
                    }
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { stamina: state.playerPokemon.stamina + action.attack.power }) });
                }
            } else if (action.attack.type === "modifying_enemy") {
                if (action.attack.target === "atk") {
                    return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { atk: state.randomPokemon.atk - action.attack.power }) });
                }
                if (action.attack.target === "def") {
                    return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { def: state.randomPokemon.def - action.attack.power }) });
                }
                if (action.attack.target === "specAtk") {
                    return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { specAtk: state.randomPokemon.specAtk - action.attack.power }) });
                }
                if (action.attack.target === "specDef") {
                    return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { specDef: state.randomPokemon.specDef - action.attack.power }) });
                }
                if (action.attack.target === "speed") {
                    return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { speed: state.randomPokemon.speed - action.attack.power }) });
                }
            } else {
                return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { stamina: state.randomPokemon.stamina - (0, _damageCalculator2.default)(action.attack, state.playerPokemon, state.randomPokemon) }) });
            }
            break;
        case "RANDOM_POKEMON_ATTACK_SELECTED":
            if (action.attack.type === "modifying_myself") {
                ...
                if (action.attack.target === "stamina") {
                    return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { stamina: state.randomPokemon.stamina - action.attack.power }) });
                }
                if (action.attack.target === "stamina") {
                    if (state.randomPokemon.stamina + action.attack.power > action.stamina) {
                        return _extends({}, state, { randomPokemon: _extends({}, state.randomPokemon, { stamina: action.stamina }) });
                    }
                    return _extends({}, state, { randomPokemon: _extends({}, state.playerPokemon, { stamina: state.randomPokemon.stamina + action.attack.power }) });
                }
            } else if (action.attack.type === "modifying_enemy") {
                if (action.attack.target === "atk") {
                    return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { atk: state.playerPokemon.atk + action.attack.power }) });
                ...
                return _extends({}, state, { playerPokemon: _extends({}, state.playerPokemon, { stamina: state.playerPokemon.stamina - (0, _damageCalculator2.default)(action.attack, state.randomPokemon, state.playerPokemon) }) });
            }
            break;
        case "PASSING_ATTACK_INFO_TO_DISPLAY":
            return _extends({}, state, { attackToDisplay: action.attack });
        default:
            return state;
    }
}

function selectedRandomPokemon() {
...
function calculateDmg(attack, pokemon1, pokemon2) {
    var hitRatio = Math.floor(Math.random() * 100 + 1);
    if (hitRatio > attack.accuracy) {
        ...
        if (attack.type === "modifying_myself" && attack.type === "modifying_enemy") {
            ...
            if (attack.type === "special") {
                var dmgSpec = Math.ceil((pokemon1.lvl * 2 / 5 + 2) * attack.power * (pokemon1.specAtk / pokemon2.specDef) / 50);
                ...
                var dmgNorm = Math.ceil((pokemon1.lvl * 2 / 5 + 2) * attack.power * (pokemon1.atk / pokemon2.def) / 50);
                if (pokemon2.weakTo.indexOf(attack.nature) !== -1) {
                    return dmgNorm * 2;
                } else if (pokemon2.resistantTo.indexOf(attack.nature) !== -1) {
                    return dmgNorm / 4;
...
module.exports = __webpack_require__.p + "src/imgs/doduo_back.png";

/***/ }),
/* 106 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/imgs/goldeen-back.png";

/***/ }),
/* 107 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/imgs/licktung_back.png";

/***/ }),
/* 108 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/imgs/psyduck-back.png";
...
module.exports = __webpack_require__.p + "src/imgs/magikarp-back.png";

/***/ }),
/* 111 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "src/imgs/flareon-back.png";
...
module.exports = __webpack_require__.p + "src/imgs/vapreon-back.png";
...
var _endGameScreen = __webpack_require__(120);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("div", { className: "connector" }),
                    _react2.default.createElement(
                        "div",
...
var _allActions = __webpack_require__(41);
...
//classes and renders
var PickPokemon = function (_React$Component) {
    _inherits(PickPokemon, _React$Component);
    ...
    function PickPokemon() {
        ...
        _classCallCheck(this, PickPokemon);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PickPokemon.__proto__ || Object.getPrototypeOf(PickPokemon)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
            if (typeof _this.props.onConfirm === "function") {
                _this.props.onConfirm();
            ...
            return _pokemons2.default.map(function (pokemon) {
                return _react2.default.createElement(
                    "li",
                    { className: "pokemon-in-list", key: pokemon.id, onClick: function onClick() {
                            return _this.props.clickedPokemon(pokemon);
                        } },
                    _react2.default.createElement("img", { className: "pokemon", src: pokemon.gif_attack }),
                    _react2.default.createElement(
                        "div",
        ...
        }, _this.generateListOfTypes = function () {
            return _this.props.pokemon.type.map(function (type, i) {
                return _react2.default.createElement(
                    "li",
                    { style: { backgroundColor: _this.generateProperBackground(type) }, key: type + i },
                    type
                );
            });
        }, _this.generateProperBackground = function (type) {
            if (type === "grass") {
                return "#00b33c";
            }
            if (type === "water") {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "inner-row-1" },
                                _react2.default.createElement(
                                    "div",
                                    { className: "pokemon-img-and-name" },
                                    _react2.default.createElement(
                                        "h2",
                                        null,
                                        this.props.pokemon.id
                                    ),
                                    _react2.default.createElement("img", { className: "pokemon-img", src: this.props.pokemon.gif_calm })
                                ),
                                _react2.default.createElement(
                                    "div",
                                    { className: "pokemon-stat-list-box" },
                                    _react2.default.createElement(
                                        "ul",
                                        { className: "pokemon-stat-list" },
                                        _react2.default.createElement(
                                            "li",
                                            null,
                                            _react2.default.createElement(
                                                "span",
                                                { className: "hp-stat-name" },
                                                "hp"
                                            ),
                                            _react2.default.createElement(
                                                "span",
                                                { className: "hp-stat-number" },
                                                this.props.pokemon.stamina,
                                                _react2.default.createElement(
                                                    "span",
                                                    { className: "hp-life-bar" },
                                                    _react2.default.createElement(
                                                        "span",
                                                        { className: "hp-hp-title" },
                                                        "HP"
                                                    ),
                                                    _react2.default.createElement("span", { className: "hp-green-bar" })
                                                )
                                            )
                                        ),
                                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "inner-row-3" },
                                _react2.default.createElement(
                                    "ul",
                                    { className: "attack-list-1-2" },
                                    _react2.default.createElement(
                                        "li",
                                        null,
                                        _react2.default.createElement(
                                            ...
                                            pokemon.attacks[0].id
                                        ),
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-nature", style: { backgroundColor: this.generateProperBackground(pokemon.attacks[0].nature) } },
                                            pokemon.attacks[0].nature
                                        )
                                    ),
                                    _react2.default.createElement(
                                        "li",
                                        ...
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-name" },
                                            pokemon.attacks[1].id
                                        ),
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-nature", style: { backgroundColor: this.generateProperBackground(pokemon.attacks[1].nature) } },
                                            pokemon.attacks[1].nature
                                        )
                                    )
                                ),
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-name" },
                                            pokemon.attacks[2].id
                                        ),
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-nature", style: { backgroundColor: this.generateProperBackground(pokemon.attacks[2].nature) } },
                                            pokemon.attacks[2].nature
                                        )
                                    ),
                                    _react2.default.createElement(
                                        "li",
                                        ...
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-name" },
                                            pokemon.attacks[3].id
                                        ),
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-nature", style: { backgroundColor: this.generateProperBackground(pokemon.attacks[3].nature) } },
                                            pokemon.attacks[3].nature
                                        )
                                    )
                                )
                            )
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "button-changing-container", disabled: false, onClick: this.handleClick },
                                "Ready for battle?"
                            )
                        )
                    )
...
function matchDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({
        clickedPokemon: _allActions2.default.clickedPokemon,
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, matchDispatchToProps)(PickPokemon);
...
var Battle = function (_React$Component) {
    ...
    function Battle(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Battle.__proto__ || Object.getPrototypeOf(Battle)).call(this, props));

        _this.handleLifeBarChange = function (staticStaminaValue, changingPokemonStamina) {
            var lifeBarLength = changingPokemonStamina * 100 / staticStaminaValue;
            if (lifeBarLength <= 0) {
                return 0;
        ...
        _this.handleColorChange = function (functionA) {
            if (functionA <= 19) {
                return "#e60000";
        ...
        _this.handleStaminaPoints = function (a) {
            if (a < 0) {
                return 0;
            } else {
                return Math.floor(a);
        ...
        var playerBaseStamina = _this.props.battleReducer.playerPokemon.stamina;
        var randomBaseStamina = _this.props.battleReducer.randomPokemon.stamina;
        _this.state = {
            displayAttacks: "none",
            displayText: "none",
    ...
    _createClass(Battle, [{
        ...
        value: function handleAttackAction(attack) {
            var _this3 = this;

            // wymaga optymalizacji
            var playerPokemon = this.props.battleReducer.playerPokemon;
            var randomPokemon = this.props.battleReducer.randomPokemon;
            if (attack.type === "modifying_myself" || attack.type === "modifying_enemy") {
                this.setState({
                    displayText: "block",
                    displayAttacks: "none",
            ...
            setTimeout(function () {
                var randomPokemonStamina = _this3.props.battleReducer.randomPokemon.stamina;
                _this3.props.playerClickedAttack(attack, _this3.state.playerBaseStamina);
                if (attack.type === "modifying_myself") {
                    if (attack.targetName === "stamina") {
                        if (_this3.state.playerBaseStamina === playerPokemon.stamina) {
                            _this3.setState({
                    ...
                    if (randomPokemonStamina === _this3.props.battleReducer.randomPokemon.stamina) {
                        _this3.setState({
                            textArea: playerPokemon.id + " missed"
                        });
                    } else {
                        _this3.setState({ //tu się aktywuje animacja playerPokemona
                            playerAnimation: "scratch-player-send 0.5s linear 1",
                            randomAnimation: "scratch-random-receive 0.5s linear 1"
                        });
                    }
                }
                if (_this3.props.battleReducer.randomPokemon.stamina >= 0) {
                    setTimeout(function () {
                        var randomAttack = randomPokemon.attacks[Math.floor(Math.random() * 3)];
                        _this3.setState({ // tu się zeruje animacja playerpokemona
                            playerAnimation: "",
                            randomAnimation: ""
                        });
                        ...
                        setTimeout(function () {
                            var playerPokemonStamina = _this3.props.battleReducer.playerPokemon.stamina;
                            _this3.props.randomSelectedAttack(randomAttack, _this3.state.randomBaseStamina);
                            if (randomAttack.type === "modifying_myself") {
                                if (randomAttack.targetName === "stamina") {
                                    if (_this3.state.randomBaseStamina === randomPokemon.stamina) {
                                        _this3.setState({
                                ...
                                if (playerPokemonStamina === _this3.props.battleReducer.playerPokemon.stamina) {
                                    _this3.setState({
                            ...
                            if (_this3.props.battleReducer.playerPokemon.stamina <= 0) {
                                setTimeout(function () {
                                    _this3.setState({
                                        display: "none",
        ...
        value: function render() {
            ...
            var attacks = this.props.battleReducer.playerPokemon.attacks;
            var playerPokeStamina = this.props.battleReducer.playerPokemon.stamina;
            var randomPokeStamina = this.props.battleReducer.randomPokemon.stamina;
            var pickedAttack = this.props.battleReducer.attackToDisplay;
            var handleLifeBar1 = this.handleLifeBarChange(this.state.randomBaseStamina, randomPokeStamina);
            var handleLifeBar2 = this.handleLifeBarChange(this.state.playerBaseStamina, playerPokeStamina);
            var attackData = pickedAttack === null ? this.props.battleReducer.playerPokemon.attacks[0] : pickedAttack;
            return _react2.default.createElement(
                "div",
                { className: "game-framing" },
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    "div",
                                    { className: "inner-row-1-2b" },
                                    _react2.default.createElement(
                                        "div",
                                        { className: "pokemon-data-border" },
                                        _react2.default.createElement(
                                            "div",
                                            { className: "pokemon-data" },
                                            _react2.default.createElement(
                                                "div",
                                                { className: "pokemon-name-in-data" },
                                                this.props.battleReducer.randomPokemon.id
                                            ),
                                            _react2.default.createElement(
                                                "div",
                                                { className: "life-bar-overbar" },
                                                _react2.default.createElement(
                                                    "div",
                                                    { className: "life-bar-inner-line" },
                                                    _react2.default.createElement("div", { className: "life-bar", style: { transition: "all 1s ease-out", backgroundColor: this.handleColorChange(handleLifeBar1), height: "5px", width: handleLifeBar1, borderRadius: "2px 0 0 2px" } })
                                                )
                                            ),
                                            _react2.default.createElement(
                                                "div",
                                                { className: "stamina-points" },
                                                this.handleStaminaPoints(randomPokeStamina),
                                                "/",
                                                this.state.randomBaseStamina
                                            )
                                        )
                                    )
                                ),
                                _react2.default.createElement(
                                    "div",
                                    { className: "inner-row-1-2c" },
                                    _react2.default.createElement("img", { className: "player-pokemon-img", style: { animation: this.state.playerAnimation }, src: this.props.battleReducer.playerPokemon.gif_back, alt: "" })
                                )
                            ),
                            _react2.default.createElement(
                                "div",
                                ...
                                _react2.default.createElement(
                                    "div",
                                    { className: "inner-row-1-2a" },
                                    _react2.default.createElement("img", { className: "random-pokemon-img", style: { animation: this.state.randomAnimation }, src: this.props.battleReducer.randomPokemon.gif_calm, alt: "" })
                                ),
                                _react2.default.createElement(
                                    "div",
                                    { className: "inner-row-1-2" },
                                    _react2.default.createElement(
                                        "div",
                                        { className: "pokemon-data-border" },
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                "div",
                                                { className: "pokemon-name-in-data" },
                                                this.props.battleReducer.playerPokemon.id
                                            ),
                                            _react2.default.createElement(
                                                "div",
                                                { className: "life-bar-overbar" },
                                                _react2.default.createElement(
                                                    "div",
                                                    { className: "life-bar-inner-line" },
                                                    _react2.default.createElement("div", { style: { transition: "all 1s ease-out", backgroundColor: this.handleColorChange(handleLifeBar2), height: "5px", width: handleLifeBar2, borderRadius: "2px 0 0 2px" } })
                                                )
                                            ),
                                            _react2.default.createElement(
                                                "div",
                                                { className: "stamina-points" },
                                                this.handleStaminaPoints(playerPokeStamina),
                                                "/",
                                                this.state.playerBaseStamina
                                            )
                                        )
                                    )
                                )
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { style: { display: this.state.displayAttacks } },
                                _react2.default.createElement(
                                    "div",
                                    { className: "attacks-menu" },
                                    _react2.default.createElement(
                                        "div",
                                        { className: "list-of-attack-buttons" },
                                        _react2.default.createElement(
                                            "div",
                                            null,
                                            _react2.default.createElement(
                                                "div",
                                                { className: "attack-button", onMouseEnter: function onMouseEnter() {
                                                        return _this4.props.passingAttackInfo(attacks[0]);
                                                    }, onClick: function onClick() {
                                                        return _this4.handleAttackAction(attacks[0]);
                                                    } },
                                                attacks[0].id
                                            ),
                                            _react2.default.createElement(
                                                "div",
                                                { className: "attack-button", onMouseEnter: function onMouseEnter() {
                                                        return _this4.props.passingAttackInfo(attacks[1]);
                                                    }, onClick: function onClick() {
                                                        return _this4.handleAttackAction(attacks[1]);
                                                    } },
                                                attacks[1].id
                                            )
                                        ),
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                "div",
                                                { className: "attack-button", onMouseEnter: function onMouseEnter() {
                                                        return _this4.props.passingAttackInfo(attacks[2]);
                                                    }, onClick: function onClick() {
                                                        return _this4.handleAttackAction(attacks[2]);
                                                    } },
                                                attacks[2].id
                                            ),
                                            _react2.default.createElement(
                                                "div",
                                                { className: "attack-button", onMouseEnter: function onMouseEnter() {
                                                        return _this4.props.passingAttackInfo(attacks[3]);
                                                    }, onClick: function onClick() {
                                                        return _this4.handleAttackAction(attacks[3]);
                                                    } },
                                                attacks[3].id
                                            )
                                        )
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-type", style: { backgroundColor: this.generateProperBackground(attackData.nature) } },
                                            attackData.nature
                                        ),
                                        _react2.default.createElement(
                                            "div",
                                            { className: "attack-power" },
                                            "power:",
                                            attackData.power
                                        )
                                    )
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "battle-commentary-border", style: { display: this.state.displayText } },
                                _react2.default.createElement(
                                    "div",
                                    { className: "battle-commentary-inner-border" },
                                    _react2.default.createElement(
                                        "div",
                                        { className: "commentary-size" },
                                        _react2.default.createElement(
                                            "div",
                                            { className: "battle-commentary" },
                                            this.state.textArea
                                        )
                                    )
                                )
...
function matchDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({
        playerClickedAttack: _allActions2.default.playerClickedAttack,
        randomSelectedAttack: _allActions2.default.randomSelectedAttack,
        passingWinnerInfo: _allActions2.default.passingWinnerInfo,
        passingAttackInfo: _allActions2.default.passingAttackInfo
    }, dispatch);
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, matchDispatchToProps)(Battle);
...
var EndGameScreen = function (_React$Component) {
    _inherits(EndGameScreen, _React$Component);
    ...
    function EndGameScreen() {
        ...
        _classCallCheck(this, EndGameScreen);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EndGameScreen.__proto__ || Object.getPrototypeOf(EndGameScreen)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
            if (typeof _this.props.onConfirm === "function") {
                _this.props.onConfirm();
            }
        }, _this.handleWinnerText = function () {
            if (_this.props.winnerInfo === _this.props.battleReducer.playerPokemon) {
                return _react2.default.createElement(
                    "div",
                    { className: "winner-info" },
                    _react2.default.createElement("img", { src: _this.props.battleReducer.playerPokemon.gif_attack }),
                    _react2.default.createElement(
                        "div",
                        { className: "end-screen-text" },
                        "Congratulations! You won playing ",
                        _this.props.battleReducer.playerPokemon.id,
                        "!"
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "end-screen-button", onClick: _this.handleClick },
                        "play again"
                    )
                );
            } else {
                return _react2.default.createElement(
                    "div",
                    { className: "winner-info" },
                    _react2.default.createElement("img", { src: _this.props.battleReducer.randomPokemon.gif_attack }),
                    _react2.default.createElement(
                        "div",
                        { className: "end-screen-text" },
                        "You Lost to ",
                        _this.props.battleReducer.randomPokemon.id
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "end-screen-button", onClick: _this.handleClick },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(EndGameScreen);
